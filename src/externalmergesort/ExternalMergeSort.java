...
public class ExternalMergeSort {
	...
	public static void passZero() throws IOException{
		...
		BufferedReader br = new BufferedReader(new FileReader("mansisaini/NetBeansProjects/ExternalMergeSort/src/externalmergesort/age.txt"));
		String sCurrentLine;
		...
		while(seek < ar.length){
			...
			for (int i = 0; i < size && seek < ar.length; i++, seek++){
				numberArray[i] = Integer.parseInt(ar[seek]);
			}
			sort(numberArray);
